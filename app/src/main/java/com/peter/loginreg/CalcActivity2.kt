...
package com.peter.loginreg.ui.theme
...
import com.peter.loginreg.ui.theme.ui.theme.LoginregTheme
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally,
        ...
        OutlinedButton(
            onClick = {
                      ...
                      val mysecondnum1=secondnum.text.trim()
                      if (myfirstnum1.isEmpty() &&mysecondnum1.isEmpty()){
                          answer="Please fill in all details"
                      }else{
                          val myanswer=myfirstnum1.toDouble() + mysecondnum1.toDouble()
        ...
        OutlinedButton(
            onClick = {
                ...
                val mysecondnum2=secondnum.text.trim()
                if (myfirstnum2.isEmpty() &&mysecondnum2.isEmpty()){
                    answer="Please fill in all details"
                }else{
                    val myanswer=myfirstnum2.toDouble() * mysecondnum2.toDouble()
                    answer=myanswer.toString()
                }
        ...
        OutlinedButton(
            onClick = {
                ...
                val mysecondnum3=secondnum.text.trim()
                if (myfirstnum3.isEmpty() &&mysecondnum3.isEmpty()){
                    answer="Please fill in all details"
                }else{
                    val myanswer=myfirstnum3.toDouble() / mysecondnum3.toDouble()
                    answer=myanswer.toString()
                }
            },
            colors = ButtonDefaults.buttonColors(Color.Blue),
