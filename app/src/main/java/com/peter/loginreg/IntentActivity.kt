...
fun Intent() {
    ...
    Column(
        ...
        OutlinedButton(onClick = { val takePictureIntent=Intent(MediaStore.ACTION_IMAGE_CAPTURE)
        ...
        OutlinedButton(
            onClick = {
                val intent = Intent(Intent.ACTION_CALL, Uri.parse("tel:" + "+254727623740"))
        ...
        OutlinedButton(
            onClick = {
                val uri = Uri.parse("smsto:0792392619")
